...
.NOTES
    ...
    --- FIX (vs. Runbook-TagDevicesByDepartment.portal.ps1) ---
...
$skippedNoAadId  = $results | Where-Object { $_.Status -eq "Skipped — Intune device missing AzureAdDeviceId" }
...
Write-Log "Skipped  : $(($alreadyCorrect.Count + $skippedNoUser.Count + $skippedNoDept.Count + $skippedNoAadId.Count + $skippedNotEntra.Count))"
...
$resultPayload = [ordered]@{
    ...
    totals = [ordered]@{
        ...
        skippedNoAadId    = $skippedNoAadId.Count
